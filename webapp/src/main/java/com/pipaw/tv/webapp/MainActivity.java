...
//        mWebView.loadUrl(AppConfig.URL_baid);
        mWebView.loadUrl("http://open892.open.7724.com/jzsc/game?flag=open892");
    }
...
//        webSetting.setUserAgentString(webSetting.getUserAgentString() + "<libao-nolimit>");
        webSetting.setUserAgentString(webSetting.getUserAgentString() + "7724hezi,testwxpay");
